...
| **Gemini API (gemini-2.5-flash)** | NLP Engine | Fast response times (< 2s), strong Spanish language support, cost-effective for MVP, function calling for structured output |
