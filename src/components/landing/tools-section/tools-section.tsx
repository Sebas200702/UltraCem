...
function ToolCard({
  ...
  const content = (
    <Card className="group flex h-full flex-col gap-3 transition-all duration-200 hover:-translate-y-0.5 hover:border-ultracem-blue hover:shadow-uc-card">
      <div className="flex h-11 w-11 items-center justify-center rounded-uc-input bg-ultracem-blue/10 text-ultracem-blue transition-colors group-hover:bg-ultracem-blue group-hover:text-white">
