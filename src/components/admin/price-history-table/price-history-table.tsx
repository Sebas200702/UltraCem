...
import { type PriceHistoryTableProps } from '@/components/admin/price-history-table/price-history-table-types';
  ...
  if (data.length === 0) {
    return (
      <div className="rounded-uc-card border border-ultracem-gray-100 bg-ultracem-surface p-6 shadow-uc-card">
        ...
        <p className="mt-4 text-body-sm text-ultracem-gray-600">
